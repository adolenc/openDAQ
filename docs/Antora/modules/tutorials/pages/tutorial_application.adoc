...
int main() {
  ...
  while (daqIterator_moveNext(iterator) == DAQ_SUCCESS) {
    ...
    daqCConstCharPtr connectionStringStr = NULL;
    ...
    for (daqCSizeT i = 0; i < capabilityCount; ++i) {
      ...
      if (capability != NULL) {
        ...
        daqCConstCharPtr protocolNameStr = NULL;
        ...
        daqCConstCharPtr capabilityConnectionStringStr = NULL;
