...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqEndUpdateEventArgs_getProperties(daqEndUpdateEventArgs* self, daqListObject** properties);
    daqErrCode EXPORTED daqEndUpdateEventArgs_getIsParentUpdating(daqEndUpdateEventArgs* self, daqBool* isParentUpdating);
    daqErrCode EXPORTED daqEndUpdateEventArgs_createEndUpdateEventArgs(daqEndUpdateEventArgs** obj, daqListObject* properties, daqBool isParentUpdating);
