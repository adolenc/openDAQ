...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqPropertyBuilder, daqBaseObject)
    ...
    // [templateType(event, PropertyObjectPtr, PropertyValueEventArgsPtr)]
    /*!
    ...
    // [templateType(event, PropertyObject, PropertyValueEventArgs)]
    /*!
    ...
    // [templateType(event, PropertyPtr, PropertyMetadataReadArgsPtr)]
    /*!
    ...
    // [templateType(event, Property, PropertyMetadataReadArgs)]
    /*!
