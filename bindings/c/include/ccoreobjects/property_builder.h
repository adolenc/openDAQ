...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqPropertyBuilder_setValueType(daqPropertyBuilder* self, daqCCoreType type);
    daqErrCode EXPORTED daqPropertyBuilder_getValueType(daqPropertyBuilder* self, daqCCoreType* type);
    ...
    daqErrCode EXPORTED daqPropertyBuilder_setIsIntegerValueSelection(daqPropertyBuilder* self, daqCBool isIntegerValueSelection);
    daqErrCode EXPORTED daqPropertyBuilder_getIsIntegerValueSelection(daqPropertyBuilder* self, daqCBool* isIntegerValueSelection);
