...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqDataDescriptorBuilder, daqBaseObject)
    ...
    // [elementType(dimensions, Dimension)]
    /*!
    ...
    // [elementType(structFields, DataDescriptor)]
    /*!
    ...
    // [templateType(metadata, String, String)]
    /*!
