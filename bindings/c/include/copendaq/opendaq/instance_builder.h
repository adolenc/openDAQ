...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqInstanceBuilder, daqBaseObject)
    ...
    // [templateType(components, String, Number)]
    /*!
    ...
    // [elementType(serverNames, String)]
    /*!
