...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqInstanceBuilder_setComponentLogLevel(daqInstanceBuilder* self, daqStringObject* component, daqLogLevel logLevel);
    daqErrCode EXPORTED daqInstanceBuilder_getComponentsLogLevel(daqInstanceBuilder* self, daqDictObject** components);
    ...
    daqErrCode EXPORTED daqInstanceBuilder_getLoggerSinks(daqInstanceBuilder* self, daqListObject** sinks);
    daqErrCode EXPORTED daqInstanceBuilder_setModulePath(daqInstanceBuilder* self, daqStringObject* path);
    daqErrCode EXPORTED daqInstanceBuilder_getModulePath(daqInstanceBuilder* self, daqStringObject** path);
    daqErrCode EXPORTED daqInstanceBuilder_addModulePath(daqInstanceBuilder* self, daqStringObject* path);
    daqErrCode EXPORTED daqInstanceBuilder_getModulePathsList(daqInstanceBuilder* self, daqListObject** paths);
    ...
    daqErrCode EXPORTED daqInstanceBuilder_setDefaultRootDeviceLocalId(daqInstanceBuilder* self, daqStringObject* localId);
    daqErrCode EXPORTED daqInstanceBuilder_getDefaultRootDeviceLocalId(daqInstanceBuilder* self, daqStringObject** localId);
    daqErrCode EXPORTED daqInstanceBuilder_setRootDevice(daqInstanceBuilder* self, daqStringObject* connectionString, daqPropertyObject* config);
    daqErrCode EXPORTED daqInstanceBuilder_getRootDevice(daqInstanceBuilder* self, daqStringObject** connectionString);
    ...
    daqErrCode EXPORTED daqInstanceBuilder_getOptions(daqInstanceBuilder* self, daqDictObject** options);
    daqErrCode EXPORTED daqInstanceBuilder_enableStandardProviders(daqInstanceBuilder* self, daqBool flag);
    daqErrCode EXPORTED daqInstanceBuilder_getDiscoveryServers(daqInstanceBuilder* self, daqListObject** serverNames);
    daqErrCode EXPORTED daqInstanceBuilder_addDiscoveryServer(daqInstanceBuilder* self, daqStringObject* serverName);
