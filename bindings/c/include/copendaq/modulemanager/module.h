...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqModule, daqBaseObject)
    ...
    // [templateType(serverTypes, String, ServerType)]
    /*!
    ...
    // [templateType(streamingTypes, String, StreamingType)]
    /*!
    ...
    // [templateType(licenseConfig, String, String)]
    /*!
