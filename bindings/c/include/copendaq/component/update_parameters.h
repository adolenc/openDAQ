...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqUpdateParameters_getRemoveUnusedDevices(daqUpdateParameters* self, daqCBool* remove);
    daqErrCode EXPORTED daqUpdateParameters_setRemoveUnusedDevices(daqUpdateParameters* self, daqCBool remove);
