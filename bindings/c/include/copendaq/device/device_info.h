...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqDeviceInfo, daqPropertyObject)
    ...
    // [templateType(deviceType, DeviceType)]
    /*!
    ...
    // [elementType(customInfoNames, String)]
    /*!
    ...
    // [elementType(serverCapabilities, ServerCapability)]
    /*!
    ...
    // [templateType(interfaces, String, NetworkInterface)]
    /*!
    ...
    // [elementType(connectedClientsInfo, ConnectedClientInfo)]
    /*!
