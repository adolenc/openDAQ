...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqLogFileInfoBuilder_getSize(daqLogFileInfoBuilder* self, daqCSizeT* size);
    daqErrCode EXPORTED daqLogFileInfoBuilder_setSize(daqLogFileInfoBuilder* self, daqCSizeT size);
