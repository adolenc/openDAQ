...
#include <ccommon.h>
     ...
     */
    // DECLARE_OPENDAQ_INTERFACE(daqServerCapability, daqPropertyObject)
    ...
    // [elementType(connectionStrings, String)]
    /*!
     * @brief Gets the connection string of the device with the current protocol.
    ...
    // [elementType(addressInfo, AddressInfo)]
    /*!
