...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqMultiReaderBuilder_addSignals(daqMultiReaderBuilder* self, daqListObject* signals);
    daqErrCode EXPORTED daqMultiReaderBuilder_addInputPort(daqMultiReaderBuilder* self, daqInputPort* port);
    daqErrCode EXPORTED daqMultiReaderBuilder_addInputPorts(daqMultiReaderBuilder* self, daqListObject* ports);
    daqErrCode EXPORTED daqMultiReaderBuilder_getSourceComponents(daqMultiReaderBuilder* self, daqListObject** components);
    ...
    daqErrCode EXPORTED daqMultiReaderBuilder_setTickOffsetTolerance(daqMultiReaderBuilder* self, daqRatioObject* offsetTolerance);
    daqErrCode EXPORTED daqMultiReaderBuilder_getTickOffsetTolerance(daqMultiReaderBuilder* self, daqRatioObject** offsetTolerance);
    ...
    daqErrCode EXPORTED daqMultiReaderBuilder_setInputPortNotificationMethods(daqMultiReaderBuilder* self, daqListObject* notificationMethods);
    daqErrCode EXPORTED daqMultiReaderBuilder_getInputPortNotificationMethods(daqMultiReaderBuilder* self, daqListObject** notificationMethods);
