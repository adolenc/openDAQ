...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqMultiReaderBuilder_setRequiredCommonSampleRate(daqMultiReaderBuilder* self, daqCInt sampleRate);
    daqErrCode EXPORTED daqMultiReaderBuilder_getRequiredCommonSampleRate(daqMultiReaderBuilder* self, daqCInt* sampleRate);
    daqErrCode EXPORTED daqMultiReaderBuilder_setStartOnFullUnitOfDomain(daqMultiReaderBuilder* self, daqCBool enabled);
    daqErrCode EXPORTED daqMultiReaderBuilder_getStartOnFullUnitOfDomain(daqMultiReaderBuilder* self, daqCBool* enabled);
    daqErrCode EXPORTED daqMultiReaderBuilder_setMinReadCount(daqMultiReaderBuilder* self, daqCSizeT minReadCount);
    daqErrCode EXPORTED daqMultiReaderBuilder_getMinReadCount(daqMultiReaderBuilder* self, daqCSizeT* minReadCount);
    ...
    daqErrCode EXPORTED daqMultiReaderBuilder_setAllowDifferentSamplingRates(daqMultiReaderBuilder* self, daqCBool allowDifferentRates);
    daqErrCode EXPORTED daqMultiReaderBuilder_getAllowDifferentSamplingRates(daqMultiReaderBuilder* self, daqCBool* allowDifferentRates);
