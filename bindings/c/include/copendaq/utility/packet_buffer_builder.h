...
#include <ccommon.h>
    ...
    daqErrCode EXPORTED daqPacketBufferBuilder_getSizeInBytes(daqPacketBufferBuilder* self, daqCSizeT* sizeInBytes);
    daqErrCode EXPORTED daqPacketBufferBuilder_setSizeInBytes(daqPacketBufferBuilder* self, daqCSizeT sizeInBytes);
