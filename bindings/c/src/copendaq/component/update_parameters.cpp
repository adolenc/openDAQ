...
daqErrCode daqUpdateParameters_getRemoveUnusedDevices(daqUpdateParameters* self, daqCBool* remove)
{
    return reinterpret_cast<daq::IUpdateParameters*>(self)->getRemoveUnusedDevices(remove);
}

daqErrCode daqUpdateParameters_setRemoveUnusedDevices(daqUpdateParameters* self, daqCBool remove)
{
