...
{
    return reinterpret_cast<daq::ILoggerComponent*>(self)->logMessage(copendaq::utils::toDaqSourceLocation(location), static_cast<daq::ConstCharPtr>(msg), static_cast<daq::LogLevel>(level));
}
