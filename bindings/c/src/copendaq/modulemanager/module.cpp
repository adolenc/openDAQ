...
daqErrCode daqModule_getAvailableDevices(daqModule* self, daqListObject** availableDevices)
{
    return reinterpret_cast<daq::IModule*>(self)->getAvailableDevices(reinterpret_cast<daq::IList**>(availableDevices));
}

daqErrCode daqModule_getAvailableDeviceTypes(daqModule* self, daqDictObject** deviceTypes)
{
    return reinterpret_cast<daq::IModule*>(self)->getAvailableDeviceTypes(reinterpret_cast<daq::IDict**>(deviceTypes));
}

daqErrCode daqModule_createDevice(daqModule* self, daqDevice** device, daqStringObject* connectionString, daqComponent* parent, daqPropertyObject* config)
{
...
daqErrCode daqModule_getAvailableFunctionBlockTypes(daqModule* self, daqDictObject** functionBlockTypes)
{
    return reinterpret_cast<daq::IModule*>(self)->getAvailableFunctionBlockTypes(reinterpret_cast<daq::IDict**>(functionBlockTypes));
}

daqErrCode daqModule_createFunctionBlock(daqModule* self, daqFunctionBlock** functionBlock, daqStringObject* id, daqComponent* parent, daqStringObject* localId, daqPropertyObject* config)
{
...
daqErrCode daqModule_getAvailableServerTypes(daqModule* self, daqDictObject** serverTypes)
{
    return reinterpret_cast<daq::IModule*>(self)->getAvailableServerTypes(reinterpret_cast<daq::IDict**>(serverTypes));
}

daqErrCode daqModule_createServer(daqModule* self, daqServer** server, daqStringObject* serverTypeId, daqDevice* rootDevice, daqPropertyObject* config)
{
...
daqErrCode daqModule_createStreaming(daqModule* self, daqStreaming** streaming, daqStringObject* connectionString, daqPropertyObject* config)
{
...
daqErrCode daqModule_getAvailableStreamingTypes(daqModule* self, daqDictObject** streamingTypes)
{
    return reinterpret_cast<daq::IModule*>(self)->getAvailableStreamingTypes(reinterpret_cast<daq::IDict**>(streamingTypes));
}

daqErrCode daqModule_loadLicense(daqModule* self, daqBool* succeeded, daqDictObject* licenseConfig)
{
    return reinterpret_cast<daq::IModule*>(self)->loadLicense(succeeded, reinterpret_cast<daq::IDict*>(licenseConfig));
}

daqErrCode daqModule_getLicenseConfig(daqModule* self, daqDictObject** licenseConfig)
{
