...
daqErrCode daqFloat_getValue(daqFloat* self, daqCFloat* value)
{
    return reinterpret_cast<daq::IFloat*>(self)->getValue(value);
}

daqErrCode daqFloat_equalsValue(daqFloat* self, daqCFloat value, daqCBool* equals)
{
    return reinterpret_cast<daq::IFloat*>(self)->equalsValue(value, equals);
}

daqErrCode daqFloat_createFloat(daqFloat** obj, daqCFloat value)
{
...
daqErrCode daqFloat_createFloatObject(daqFloat** obj, daqCFloat value)
{
    daq::IFloat* ptr = nullptr;
